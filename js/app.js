(() => {
  ...
  class ne {
    constructor() {
      ...
      (a.__swiper__ = !0),
        (a.support = $()),
        (a.device = P({ userAgent: t.userAgent })),
        (a.browser = L()),
        (a.eventsListeners = {}),
    ...
    function d() {
      ...
      if (
        ...
        e.children(`.${s.slideVisibleClass}`).each((e) => {
          l(a ? g(e).attr("data-swiper-slide-index") : g(e).index());
        });
  ...
  window.addEventListener("load", function (e) {
    he(),
      ...
      document.querySelector(".body-featured-slider") &&
        new ae(".body-featured-slider", {
          modules: [le, ce],
          autoplay: { delay: 3e3, disableOnInteraction: !1 },
          observer: !0,
          observeParents: !0,
  ...
  setTimeout(() => {
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".slide-main-slider__module-video") &&
        document
          .querySelector(".slide-main-slider__module-video")
          .addEventListener("click", () => {
            document
              .querySelector(".slide-main-slider__module-video")
              .classList.contains("_active")
              ? document
                  .querySelector(".slide-main-slider__module-item")
                  .pause()
              : document
                  .querySelector(".slide-main-slider__module-item")
                  .play(),
        ...
        document.querySelector(".why-choose__video") &&
          document
            .querySelector(".why-choose__video")
            .addEventListener("click", () => {
              document
                .querySelector(".why-choose__video")
                .classList.contains("_active")
                ? document.querySelector(".why-choose__video-item").pause()
                : document.querySelector(".why-choose__video-item").play(),
                document
                  .querySelector(".why-choose__video")
                  .classList.toggle("_active");
            }),
        document.querySelector(".media__cards") &&
          document
            .querySelector(".media__button")
            .addEventListener("click", () => {
              document
                .querySelector(".media__cards")
                .classList.contains("active-media")
                ? ((document.querySelector(
                    ".media__cards"
                  ).style.gridAutoRows = 0),
                  (document.querySelector(".media__cards").style.overflow =
                    "hidden"),
                  document
                    .querySelector(".media__cards")
                    .classList.remove("active-media"),
                  (document.querySelector(".media__button").innerHTML =
                    "View All"))
                : ((document.querySelector(".media__cards").style.gridAutoRows =
                    "300px"),
                  (document.querySelector(".media__cards").style.overflow =
                    "visiable"),
                  document
                    .querySelector(".media__cards")
                    .classList.add("active-media"),
                  (document.querySelector(".media__button").innerHTML =
                    "Hide All"));
            });
    }),
  ...
  new Swiper(".body-projects-slider", {
    slidesPerView: 3,
    grid: { rows: 2 },
    spaceBetween: 30,
    pagination: { el: ".projects__controll", clickable: !0 },
    breakpoints: {
      320: { slidesPerView: 1, spaceBetween: 30 },
      768: { slidesPerView: 2, spaceBetween: 15 },
